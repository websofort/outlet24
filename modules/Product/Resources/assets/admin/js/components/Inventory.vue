<template>
    <div class="box-header">
        <h5>
            {{ trans("product::products.group.inventory") }}
        </h5>
        ...
        <template v-else>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    ...
                    <span
                        class="help-block text-red"
                        v-if="errors.has('manage_stock')"
                        v-text="errors.get('manage_stock')"
                    ></span>
                </div>
            </div>
            ...
            <div class="form-group row">
                <label for="in-stock" class="col-sm-12 control-label text-left">
                ...
                <div class="col-sm-12">
                    ...
                    <span
                        class="help-block text-red"
                        v-if="errors.has('in_stock')"
                        v-text="errors.get('in_stock')"
                    ></span>
                </div>
            </div>
        </template>
...
const { form, errors, focusField } = useForm();
